...
var left = document.getElementById('left'),
	...
	cabel = document.getElementById('cabel'),
...
function update() {
	data = {
		...
		cabel: _createDataArray('cabel'),
		links: links.value.split('\n')
	};
	while (mufta.lastChild) {
		mufta.removeChild(mufta.lastChild);
	}
	mufta.setAttribute('height', Math.max(data.left.length, data.right.length, data.cabel.length) * sizes.cableHeight + 1);
	renderCables();
	renderLinks();
}
